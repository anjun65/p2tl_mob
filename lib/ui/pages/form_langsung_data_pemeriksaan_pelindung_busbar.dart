...
class FormLangsungDataPemeriksaanPelindungBusbar extends StatefulWidget {
  final Function onBackButtonPressed;
  FormLangsungDataPemeriksaanPelindungBusbar({this.onBackButtonPressed});

  bool isLoading = false;

  @override
  _FormLangsungDataPemeriksaanPelindungBusbarState createState() =>
      _FormLangsungDataPemeriksaanPelindungBusbarState();
}

class _FormLangsungDataPemeriksaanPelindungBusbarState
    extends State<FormLangsungDataPemeriksaanPelindungBusbar> {
  ...
  Widget build(BuildContext context) {
    return GeneralPage(
      title: 'Form Phase 1',
      subtitle: "Pintu Box App/Pelindung Busbar",
      onBackButtonPressed: () {
        Get.back();
      },
      child: Column(
        children: [
          ...
          Container(
            ...
            child: RaisedButton(
              onPressed: () {
                Get.to(FormLangsungDataPemeriksaanPapan(
                  onBackButtonPressed: () {
                    Get.back();
                  },
                ));
