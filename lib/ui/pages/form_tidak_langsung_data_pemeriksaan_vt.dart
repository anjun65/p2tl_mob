...
class FormTidakLangsungDataPemeriksaanVt extends StatefulWidget {
  final Function onBackButtonPressed;
  FormTidakLangsungDataPemeriksaanVt({this.onBackButtonPressed});

  bool isLoading = false;

  @override
  _FormTidakLangsungDataPemeriksaanVtState createState() =>
      _FormTidakLangsungDataPemeriksaanVtState();
}

class _FormTidakLangsungDataPemeriksaanVtState
    extends State<FormTidakLangsungDataPemeriksaanVt> {
  ...
  Widget build(BuildContext context) {
    return GeneralPage(
      ...
      subtitle: "Pelindung Terminal VT & Relay",
      onBackButtonPressed: () {
        Get.back();
      },
      child: Column(
        children: [
          ...
          Container(
            ...
            child: RaisedButton(
              onPressed: () {
                Get.to(FormTidakLangsungDataPemeriksaanCt(
                  onBackButtonPressed: () {
                    Get.back();
                  },
                ));
