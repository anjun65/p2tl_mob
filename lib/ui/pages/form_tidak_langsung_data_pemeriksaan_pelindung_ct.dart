...
class FormTidakLangsungDataPemeriksaanPelindungCT extends StatefulWidget {
  final Function onBackButtonPressed;
  FormTidakLangsungDataPemeriksaanPelindungCT({this.onBackButtonPressed});

  bool isLoading = false;

  @override
  _FormTidakLangsungDataPemeriksaanPelindungCTState createState() =>
      _FormTidakLangsungDataPemeriksaanPelindungCTState();
}

class _FormTidakLangsungDataPemeriksaanPelindungCTState
    extends State<FormTidakLangsungDataPemeriksaanPelindungCT> {
  ...
  Widget build(BuildContext context) {
    return GeneralPage(
      ...
      subtitle: "Pintu Box App/Pelindung CT dan Pembatas",
      onBackButtonPressed: () {
        Get.back();
      },
      child: Column(
        children: [
          ...
          Container(
            ...
            child: RaisedButton(
              onPressed: () {
                Get.to(FormTidakLangsungDataPemeriksaanKwhMeter(
                  onBackButtonPressed: () {
                    Get.back();
                  },
                ));
