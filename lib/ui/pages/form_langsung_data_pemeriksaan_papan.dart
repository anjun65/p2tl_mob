...
class FormLangsungDataPemeriksaanPapan extends StatefulWidget {
  final Function onBackButtonPressed;
  FormLangsungDataPemeriksaanPapan({this.onBackButtonPressed});

  bool isLoading = false;

  @override
  _FormLangsungDataPemeriksaanPapanState createState() =>
      _FormLangsungDataPemeriksaanPapanState();
}

class _FormLangsungDataPemeriksaanPapanState
    extends State<FormLangsungDataPemeriksaanPapan> {
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: RaisedButton(
              onPressed: () {
                Get.to(FormLangsungDataPemeriksaanBox(
                  onBackButtonPressed: () {
                    Get.back();
                  },
                ));
