...
class FormTidakLangsungDataPemeriksaanPintuGardu extends StatefulWidget {
  final Function onBackButtonPressed;
  FormTidakLangsungDataPemeriksaanPintuGardu({this.onBackButtonPressed});

  bool isLoading = false;

  @override
  _FormTidakLangsungDataPemeriksaanPintuGarduState createState() =>
      _FormTidakLangsungDataPemeriksaanPintuGarduState();
}

class _FormTidakLangsungDataPemeriksaanPintuGarduState
    extends State<FormTidakLangsungDataPemeriksaanPintuGardu> {
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: RaisedButton(
              onPressed: () {
                Get.to(FormTidakLangsungPemeriksaanDataWiring(
                  onBackButtonPressed: () {
                    Get.back();
                  },
                ));
