...
class FormTidakLangsungDataPemeriksaanTutupTerminal extends StatefulWidget {
  final Function onBackButtonPressed;
  FormTidakLangsungDataPemeriksaanTutupTerminal({this.onBackButtonPressed});

  bool isLoading = false;

  @override
  _FormTidakLangsungDataPemeriksaanTutupTerminalState createState() =>
      _FormTidakLangsungDataPemeriksaanTutupTerminalState();
}

class _FormTidakLangsungDataPemeriksaanTutupTerminalState
    extends State<FormTidakLangsungDataPemeriksaanTutupTerminal> {
  ...
  Widget build(BuildContext context) {
    return GeneralPage(
      ...
      subtitle: "Tutup terminal kWh Meter",
      onBackButtonPressed: () {
        Get.back();
      },
      child: Column(
