...
class FormTidakLangsungDataPemeriksaanKwhMeter extends StatefulWidget {
  final Function onBackButtonPressed;
  FormTidakLangsungDataPemeriksaanKwhMeter({this.onBackButtonPressed});

  bool isLoading = false;

  @override
  _FormTidakLangsungDataPemeriksaanKwhMeterState createState() =>
      _FormTidakLangsungDataPemeriksaanKwhMeterState();
}

class _FormTidakLangsungDataPemeriksaanKwhMeterState
    extends State<FormTidakLangsungDataPemeriksaanKwhMeter> {
  ...
  Widget build(BuildContext context) {
    return GeneralPage(
      ...
      subtitle: "KWH Meter & Segel Metrologi kWh Meter",
      onBackButtonPressed: () {
        Get.back();
      },
      child: Column(
        children: [
          ...
          Container(
            ...
            child: RaisedButton(
              onPressed: () {
                Get.to(FormTidakLangsungDataPemeriksaanTutupTerminal(
                  onBackButtonPressed: () {
                    Get.back();
                  },
                ));
