...
class FormLangsungDataAppBaru extends StatefulWidget {
  final Function onBackButtonPressed;
  FormLangsungDataAppBaru({this.onBackButtonPressed});

  bool isLoading = false;

  @override
  _FormLangsungDataAppBaruState createState() =>
      _FormLangsungDataAppBaruState();
}

class _FormLangsungDataAppBaruState extends State<FormLangsungDataAppBaru> {
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: RaisedButton(
              onPressed: () {
                Get.to(FormLangsungDataPemeriksaanKwhMeter(
                  onBackButtonPressed: () {
                    Get.back();
                  },
                ));
