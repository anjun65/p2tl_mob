...
class FormTidakLangsungDataPemeriksaanBoxAmr extends StatefulWidget {
  final Function onBackButtonPressed;
  FormTidakLangsungDataPemeriksaanBoxAmr({this.onBackButtonPressed});

  bool isLoading = false;

  @override
  _FormTidakLangsungDataPemeriksaanBoxAmrState createState() =>
      _FormTidakLangsungDataPemeriksaanBoxAmrState();
}

class _FormTidakLangsungDataPemeriksaanBoxAmrState
    extends State<FormTidakLangsungDataPemeriksaanBoxAmr> {
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: RaisedButton(
              onPressed: () {
                Get.to(FormTidakLangsungDataPemeriksaanVt(
                  onBackButtonPressed: () {
                    Get.back();
                  },
                ));
