...
class FormLangsungDataPemeriksaanKwhMeter extends StatefulWidget {
  final Function onBackButtonPressed;
  FormLangsungDataPemeriksaanKwhMeter({this.onBackButtonPressed});

  bool isLoading = false;

  @override
  _FormLangsungDataPemeriksaanKwhMeterState createState() =>
      _FormLangsungDataPemeriksaanKwhMeterState();
}

class _FormLangsungDataPemeriksaanKwhMeterState
    extends State<FormLangsungDataPemeriksaanKwhMeter> {
  ...
  Widget build(BuildContext context) {
    return GeneralPage(
      title: 'Form Phase 1',
      subtitle: "KWH Meter dan Segel Metrologi KWH Meter",
      onBackButtonPressed: () {
        Get.back();
      },
      child: Column(
        children: [
          ...
          Container(
            ...
            child: RaisedButton(
              onPressed: () {
                Get.to(FormLangsungDataPemeriksaanTerminal(
                  onBackButtonPressed: () {
                    Get.back();
                  },
                ));
