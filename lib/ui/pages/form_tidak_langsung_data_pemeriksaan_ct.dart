...
class FormTidakLangsungDataPemeriksaanCt extends StatefulWidget {
  final Function onBackButtonPressed;
  FormTidakLangsungDataPemeriksaanCt({this.onBackButtonPressed});

  bool isLoading = false;

  @override
  _FormTidakLangsungDataPemeriksaanCtState createState() =>
      _FormTidakLangsungDataPemeriksaanCtState();
}

class _FormTidakLangsungDataPemeriksaanCtState
    extends State<FormTidakLangsungDataPemeriksaanCt> {
  ...
  Widget build(BuildContext context) {
    return GeneralPage(
      ...
      subtitle: "Pelindung Terminal CT & Relay",
      onBackButtonPressed: () {
        Get.back();
      },
      child: Column(
        children: [
          ...
          Container(
            ...
            child: RaisedButton(
              onPressed: () {
                Get.to(FormTidakLangsungDataPemeriksaanPintuGardu(
                  onBackButtonPressed: () {
                    Get.back();
                  },
                ));
