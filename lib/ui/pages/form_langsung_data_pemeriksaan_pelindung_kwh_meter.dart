...
class FormLangsungDataPemeriksaanPelindungKwhMeter extends StatefulWidget {
  final Function onBackButtonPressed;
  FormLangsungDataPemeriksaanPelindungKwhMeter({this.onBackButtonPressed});

  bool isLoading = false;

  @override
  _FormLangsungDataPemeriksaanPelindungKwhMeterState createState() =>
      _FormLangsungDataPemeriksaanPelindungKwhMeterState();
}

class _FormLangsungDataPemeriksaanPelindungKwhMeterState
    extends State<FormLangsungDataPemeriksaanPelindungKwhMeter> {
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: RaisedButton(
              onPressed: () {
                Get.to(FormLangsungDataPemeriksaanPelindungBusbar(
                  onBackButtonPressed: () {
                    Get.back();
                  },
                ));
