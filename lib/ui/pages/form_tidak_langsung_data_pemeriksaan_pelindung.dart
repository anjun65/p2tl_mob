...
class FormTidakLangsungDataPemeriksaanPelindungKwhMeter extends StatefulWidget {
  final Function onBackButtonPressed;
  FormTidakLangsungDataPemeriksaanPelindungKwhMeter({this.onBackButtonPressed});

  bool isLoading = false;

  @override
  _FormTidakLangsungDataPemeriksaanPelindungKwhMeterState createState() =>
      _FormTidakLangsungDataPemeriksaanPelindungKwhMeterState();
}

class _FormTidakLangsungDataPemeriksaanPelindungKwhMeterState
    extends State<FormTidakLangsungDataPemeriksaanPelindungKwhMeter> {
  ...
  Widget build(BuildContext context) {
    return GeneralPage(
      ...
      subtitle: "Pintu Box App/Pelindung kWh Meter",
      onBackButtonPressed: () {
        Get.back();
      },
      child: Column(
        children: [
          ...
          Container(
            ...
            child: RaisedButton(
              onPressed: () {
                Get.to(FormTidakLangsungDataPemeriksaanPelindungCT(
                  onBackButtonPressed: () {
                    Get.back();
                  },
                ));
