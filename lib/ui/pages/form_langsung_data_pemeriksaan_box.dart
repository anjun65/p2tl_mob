...
class FormLangsungDataPemeriksaanBox extends StatefulWidget {
  final Function onBackButtonPressed;
  FormLangsungDataPemeriksaanBox({this.onBackButtonPressed});

  bool isLoading = false;

  @override
  _FormLangsungDataPemeriksaanBoxState createState() =>
      _FormLangsungDataPemeriksaanBoxState();
}

class _FormLangsungDataPemeriksaanBoxState
    extends State<FormLangsungDataPemeriksaanBox> {
  ...
  Widget build(BuildContext context) {
    return GeneralPage(
      title: 'Form Phase 1',
      subtitle: "Box Penutup MCB/Pembatas",
      onBackButtonPressed: () {
        Get.back();
      },
      child: Column(
        children: [
          ...
          Container(
            ...
            child: RaisedButton(
              onPressed: () {
                Get.to(FormLangsungPemeriksaanPengukuran(
                  onBackButtonPressed: () {
                    Get.back();
                  },
                ));
