...
class FormTidakLangsungDataPemeriksaanPintuKubikel extends StatefulWidget {
  final Function onBackButtonPressed;
  FormTidakLangsungDataPemeriksaanPintuKubikel({this.onBackButtonPressed});

  bool isLoading = false;

  @override
  _FormTidakLangsungDataPemeriksaanPintuKubikelState createState() =>
      _FormTidakLangsungDataPemeriksaanPintuKubikelState();
}

class _FormTidakLangsungDataPemeriksaanPintuKubikelState
    extends State<FormTidakLangsungDataPemeriksaanPintuKubikel> {
  ...
  Widget build(BuildContext context) {
    return GeneralPage(
      ...
      subtitle: "Pintu Kubikel/Pelindung terminal VT",
      onBackButtonPressed: () {
        Get.back();
      },
      child: Column(
        children: [
          ...
          Container(
            ...
            child: RaisedButton(
              onPressed: () {
                Get.to(FormTidakLangsungDataPemeriksaanBoxAmr(
                  onBackButtonPressed: () {
                    Get.back();
                  },
                ));
