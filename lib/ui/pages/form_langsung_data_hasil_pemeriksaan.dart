...
class FormLangsungDataHasilPemeriksaan extends StatefulWidget {
  final Function onBackButtonPressed;
  FormLangsungDataHasilPemeriksaan({this.onBackButtonPressed});

  bool isLoading = false;

  @override
  _FormLangsungDataHasilPemeriksaanState createState() =>
      _FormLangsungDataHasilPemeriksaanState();
}

class _FormLangsungDataHasilPemeriksaanState
    extends State<FormLangsungDataHasilPemeriksaan> {
